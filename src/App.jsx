    ...
    <div className="site-shell">
      <header className="site-header">
        ...
        <nav id="primary-nav" className={menuOpen ? 'primary-nav is-open' : 'primary-nav'} aria-label="Primary navigation">
          {['About', 'Experience', 'Skills', 'Projects', 'Resume', 'Briefing', 'Connect'].map((item) => <a key={item} href={['Briefing', 'Connect'].includes(item) ? `#${item.toLowerCase()}` : `/${item.toLowerCase()}`} onClick={closeMenu}>{item}</a>)}
        </nav>
      ...
      <main id="top">
        <section className="hero-section page-grid">
          ...
          <div className="avatar-stage" aria-label="Illustrated neutral developer avatar placeholder" role="img">
            ...
            <div className="avatar-placeholder"><div className="avatar-hair" /><div className="avatar-head"><div className="avatar-eye left" /><div className="avatar-eye right" /><div className="avatar-beard" /></div><div className="avatar-body"><span>⌘</span></div></div>
