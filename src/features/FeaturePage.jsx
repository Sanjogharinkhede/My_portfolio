...
import { createBriefing, getBriefingCapacity } from '../lib/briefingClient.js'
...
function BriefingPage() {
  ...
  useEffect(() => {
    if (geminiEnabled) getBriefingCapacity().then(setCapacity).catch(() => setCapacity(null))
  }, [geminiEnabled])
...
function ConnectPage() {
  const [form, setForm] = useState({ name: '', email: '', companyOrRole: '', subject: 'Hiring opportunity', message: '' })
  const [status, setStatus] = useState('idle')
